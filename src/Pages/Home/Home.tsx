...
import { DAP_Arch, DS_Arch, H_Arch, LP_Arch, PlayDrive, PlayFairway, PlayLong, PlayPutt, PlayShort } from '../../Utils/GolfSimulation';
        ...
        <div className='Home'>
            ...
            <div className='Contents'>
                ...
                <div className='DialogCard BeginGameCard'>
                    ...
                    <Button
                        onClick={() => {
                            const result = PlayDrive(700, 1, 1, 1, 1);
                            console.log('shots: ' + result[result.length - 2] + ' \n dist remaining: ' + result[result.length - 1]);
                        }}
                    >
                        Play Drive
                    </Button>
                    ...
                    <Button
                        onClick={() => {
                            const result = PlayFairway(450, 1, 1, 1, 0);
                            console.log('shots: ' + result[result.length - 2] + ' \n dist remaining: ' + result[result.length - 1]);
                        }}
                    >
                        Play Fairway
                    ...
                    <Button
                        onClick={() => {
                            const result = PlayPutt(15, 3, 3, 0.5);
                            console.log('shots: ' + result[result.length - 2] + ' \n dist remaining: ' + result[result.length - 1]);
                        }}
                    >
                        Play Putt
                    ...
                    <Button
                        onClick={() => {
                            const result = PlayShort(450, 1, 1, 0.5);
                            // console.log(result);
                            console.log('shots: ' + result[result.length - 2] + ' \n dist remaining: ' + result[result.length - 1]);
                        }}
                    >
                    ...
                    <Button
                        onClick={() => {
                            const result = PlayLong(700, 3, 25, 1);
                            console.log('shots: ' + result[result.length - 2] + ' \n dist remaining: ' + result[result.length - 1]);
                        }}
                    >
                        Play Long
                    ...
                    <Button
                        onClick={() => {
                            const result = H_Arch(700, 3, 3, 5);
                            console.log('shots: ' + result[1] + ' \n cost: ' + result[5]);
                        }}
                    >
                        Play Whole Hole
                    </Button>

                    <h1>All of these are good! ^</h1>

                    <Button
                        onClick={() => {
                            const result = LP_Arch(700, 1, 2, 1, 25, 1, 5);
                            console.log('shots: ' + result[1] + ' \n cost: ' + result[5]);
                        }}
                    >
                        Play LP
                    ...
                    <Button
                        onClick={() => {
                            const result = DS_Arch(700, 3, 3, 3, 3, 5);
                            console.log('shots: ' + result[1] + ' \n cost: ' + result[5]);
                        }}
                    >
                        Play DS
                    ...
                    <Button
                        onClick={() => {
                            const result = DAP_Arch(700, 2, 2, 2, 25, 25, 25, 5);
                            console.log('shots: ' + result[1] + ' \n cost: ' + result[5]);
                            let max = 0;
